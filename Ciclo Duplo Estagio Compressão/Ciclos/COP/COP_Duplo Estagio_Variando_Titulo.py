# -*- coding: utf-8 -*-
"""
Created on Sun May 28 18:15:57 2023
...
input_values ={
    ...
    'tit_evap_g':[0.35,0.4,0.45,0.5,0.55,0.6,0.65],
    'subcooling':5,
    'superheating':5
}
...
def COP_Duplo_Estagio(cycle_inputs):
    ...
    for titulo in cycle_inputs['tit_evap_g']:
        ...
        point_5 = {'Q':titulo,'T':cycle_inputs['t_internal_g'],'refrigerant':cycle_inputs['refrigerant']}
    ...
    plt.scatter(cycle_inputs['tit_evap_g'],cop)
    plt.xlabel('Título na Saída da Geladeira')
    plt.ylabel('COP')
    plt.grid(True)
