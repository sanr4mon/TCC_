...
def derivada_T(cycle_inputs,delta = 10e-3):
    ...
    current_cycle_x = COP_Duplo_Estagio_Compress(cycle_inputs)
    new_cycle_x = COP_Duplo_Estagio_Compress(cycle_inputs_x)
...
def SD_T(cycle_inputs, delta = 10e-3, tol=10e-5, gama = 2):
...
def derivada_titulo(cycle_inputs,delta = 10e-3):
    ...
    current_cycle_y = COP_Duplo_Estagio_Compress(cycle_inputs)
    cycle_inputs_y = copy.copy(cycle_inputs)
    cycle_inputs_y['tit_evap_g'] += delta    
    new_cycle_y = COP_Duplo_Estagio_Compress(cycle_inputs_y)
...
def SD_titulo(cycle_inputs, delta = 10e-3, tol=10e-05, gama = 10e-3):
...
def derivada_superheating(cycle_inputs,delta = 10e-3):
    ...
    current_cycle_z = COP_Duplo_Estagio_Compress(cycle_inputs)
    new_cycle_z = COP_Duplo_Estagio_Compress(cycle_inputs_z)
...
def SD_superheating(cycle_inputs, delta = 10e-3, tol=10e-7, gama = 2):
...
def derivada_subcooling(cycle_inputs,delta = 10e-3):
    ...
    current_cycle_w = COP_Duplo_Estagio_Compress(cycle_inputs)
    new_cycle_w = COP_Duplo_Estagio_Compress(cycle_inputs_w)
...
def SD_subcooling(cycle_inputs, delta = 10e-3, tol=10e-4, gama = 2):
