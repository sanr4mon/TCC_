# -*- coding: utf-8 -*-
"""
Created on Sat Jun 17 21:05:33 2023
...
def derivada_T(cycle_inputs,delta = 10e-3):
    ...
    current_cycle_x = Ef_Ex_Duplo_Estagio(cycle_inputs)
    new_cycle_x = Ef_Ex_Duplo_Estagio(cycle_inputs_x)
...
def derivada_titulo(cycle_inputs,delta = 10e-3):
    ...
    current_cycle_y = Ef_Ex_Duplo_Estagio(cycle_inputs)
    cycle_inputs_y = copy.copy(cycle_inputs)
    cycle_inputs_y['tit_evap_g'] += delta    
    new_cycle_y = Ef_Ex_Duplo_Estagio(cycle_inputs_y)
...
def SD_titulo(cycle_inputs, delta = 10e-3, tol=10e-05, gama = 0.001):
...
def derivada_superheating(cycle_inputs,delta = 10e-3):
    ...
    current_cycle_z = Ef_Ex_Duplo_Estagio(cycle_inputs)
    new_cycle_z = Ef_Ex_Duplo_Estagio(cycle_inputs_z)
...
def derivada_subcooling(cycle_inputs,delta = 10e-3):
    ...
    current_cycle_w = Ef_Ex_Duplo_Estagio(cycle_inputs)
    new_cycle_w = Ef_Ex_Duplo_Estagio(cycle_inputs_w)
