# -*- coding: utf-8 -*-
"""
Created on Sun May 28 20:16:55 2023
...
def COP_Evap_Paralelo(cycle_inputs):
    for superheating in cycle_inputs['superheating']:
        ...
        point_6a = {'P':P_ETI,'T':cycle_inputs['t_internal_g'] + superheating,'refrigerant':cycle_inputs['refrigerant']}
    ...
    plt.xlabel('Superaquecimento na Geladeira')
    plt.ylabel('COP')
    plt.grid(True)
