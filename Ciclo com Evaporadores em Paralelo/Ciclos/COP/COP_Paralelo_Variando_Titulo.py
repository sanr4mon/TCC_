# -*- coding: utf-8 -*-
"""
Created on Sun May 28 20:22:52 2023
...
input_values ={
    ...
    'approach_HX':5,
    'r':1.75,
    'tit_evap_f':[0.3,0.35,0.4,0.45,0.5,0.55,0.6,0.65]
}

def COP_Evap_Paralelo(cycle_inputs):
    for titulo in cycle_inputs['tit_evap_f']:
        ...
        point_6b = {'Q':titulo,'P':P_ETB,'refrigerant':cycle_inputs['refrigerant']}
    ...
    plt.scatter(cycle_inputs['tit_evap_f'],cop)
