# -*- coding: utf-8 -*-
"""
Created on Sun May 28 18:58:46 2023
...
def COP_Evap_Serie(cycle_inputs):
    ...
    for variacao in cycle_inputs['variacao_titulo_f']:
        ...
        point_6a = {'P':P_Evap,'Q':point_5a['Q']+variacao,'refrigerant':cycle_inputs['refrigerant']}
        propriedades(point_6a)
        titulo_6a.append(point_6a['Q'])
